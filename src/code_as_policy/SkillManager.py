...
class SkillManager():
    def __init__(self, step_penalty, max_skills=50, steps_between_garbage_collection=50, k_relevant_skills=30, similarity_threshold=0.8, skills_path='skills.json'):
        self.client = OpenAI(
    ...
    def critique_and_save(self, code_string, reward):
        ...
        try:
            ...
            for skill in self.skills:
                ...
                if self.cosine_similarity(description_embedding, np.array(skill_disc_emb_list)) >= self.similarity_threshold:
